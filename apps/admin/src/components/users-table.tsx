...
async function fetchUserCount() {
    return await myfetch<{ admins: number; customers: number; volunteers: number; }>(
        () => apiBack.get(
            "/users/count"
        )
    );
    ...
    return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <p className="text-2xl font-semibold text-card-foreground">{counts?.customers}</p>
            </div>
            </div>
            <div className="flex items-center gap-3 rounded-lg border bg-card p-4">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
            ...
            <div>
                ...
                <p className="text-2xl font-semibold text-card-foreground">{counts?.volunteers}</p>
            </div>
            </div>
        </div>
